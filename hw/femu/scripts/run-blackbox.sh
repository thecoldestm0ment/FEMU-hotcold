...
sudo FEMU_EXP_LOG=${FEMU_EXP_LOG} \
     ...
     FEMU_HOT_ACCESS_THRESHOLD=${FEMU_HOT_ACCESS_THRESHOLD} \
     FEMU_HOT_CONFIRM_THRESHOLD=${FEMU_HOT_CONFIRM_THRESHOLD} \
     FEMU_HOT_DECAY_WINDOW=${FEMU_HOT_DECAY_WINDOW} \
     FEMU_HOT_DECAY=${FEMU_HOT_DECAY} \
     FEMU_HOT_IDLE_EXPIRATION_WINDOW=${FEMU_HOT_IDLE_EXPIRATION_WINDOW} \
     ./qemu-system-x86_64 \
    -name "FEMU-BBSSD-VM" \
    -enable-kvm \
    -cpu host \
